...
INSERT INTO usuarios (enabled, fecha_creacion, id, id_club, apellido, direccion, email,estado,nombre,password,rut,telefono) VALUES (1, '2025-11-13 16:46:48', 5, 2, 'Perez', 'Santa Ana 1264, San Ramon', 'ejperezcardenas@gmail.com', '1', 'Esteban', '$2a$10$FyaxJdN5Qaids2alWtSEOeo1iJFtvreZQOchWoDFMV/AFKz5k7/b.', '16074474K', '997249492');
...
INSERT INTO categorias (id,id_club, nombre,valor_cuota) VALUES (1, 1, 'Juvenil',17000);
...
INSERT INTO cuentas_bancarias (id,id_banco,id_club,email,nombre_titular,numero_cuenta,rut,tipo_cuenta) VALUES (1,1,1,'email@email.com','Titular-1',1231,'16074474-K','Cuenta Corriente');
INSERT INTO cuentas_bancarias (id,id_banco,id_club,email,nombre_titular,numero_cuenta,rut,tipo_cuenta) VALUES (2,2,2,'email@email.com','Titular-1',1231,'16074474-K','Cuenta Corriente');

INSERT INTO temporadas (id, id_club, nombre, fecha_inicio, fecha_fin, activa) VALUES (1, 2, 'Temporada 2026', '2026-01-01', '2026-12-31', 1);