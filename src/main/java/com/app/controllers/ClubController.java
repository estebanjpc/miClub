...
public class ClubController {
	...
	public String guardarUsuario(@Valid @ModelAttribute("usuario") Usuario usuario,
	    ...
	    // NUEVO: Filtrar deportistas vacíos
	        ...
	        usuario.setDeportistas(
	            usuario.getDeportistas().stream()
	                .filter(d ->
	                    ...
	                    d.getCategoria() != null // CORREGIDO: ya NO es String
	                )
	                .toList()
	        );
	    }
	    ...
	    // Si hay errores → regresar formulario
	    if (result.hasErrors()) {
	    ...
	    usuario.setEnabled(usuario.getEstado().equalsIgnoreCase("1"));
